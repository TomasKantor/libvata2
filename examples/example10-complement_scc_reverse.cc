// example10-complement_scc_reverse.cc - complementing an automaton
...
int main(int argc, char *argv[])
{
    ...
    //last scc complemented via reverse subset construction
    Nfa cmpl = complement(aut, alph, {{"algo", "sccs"}, {"reverse", "true"}});

    Nfa cmpl_remove_useless;
    remove_useless_states(&cmpl_remove_useless,cmpl);

    std::cout << cmpl_remove_useless << std::endl;
