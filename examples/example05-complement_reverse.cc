// example05-complement_reverse.cc - complementing an automaton
...
int main(int argc, char *argv[])
{
    ...
    Nfa cmpl = complement(aut, alph, {{"algo", "reverse"}});

    Nfa cmpl_remove_useless;
    remove_unreachables_states(&cmpl_remove_useless, cmpl);
